...
/**
 * Return a facade of the core module where classes are just placeholders
 * carrying a static `tag` field, allowing same code to be reused between
 * client and server, bringing hydration ability via `/tag` export too.
 * @returns {Namespace}
 */
module.exports = () => new Proxy(new Map, {
  get(map, Namespace) {
